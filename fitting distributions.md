...
Flumevale_fit_exp_1 <- fitdist(Flumevale$'Probability of Failure'[Flumevale$`haz*ass` %in% category1],
                   "exp")
plot(Flumevale_fit_exp_1) # not well , next to predict gamma和weibull
...
#Lyndrassia_fit_unit_3 is better
...
##Flumevale_fit_weibull_1，Flumevale_fit_gamma_2,Flumevale_fit_gamma_3,
...
#Flumevale_fit_weibull_loss_2 is better
